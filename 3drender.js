...
function plotSurface(func,x0,x1){
	var step=(x1-x0)/30;
	for(var s=x0;s<x1;s+=step){
		plotPath(function(t){return(func(s,t));},x0,x1);
		plotPath(function(t){return(func(t,s));},x0,x1);
	}
}

function plot(func,x0,x1){
	if(func.length==1){
		plotPath(func,x0,x1);
	}else if(func.length==2){
		plotSurface(func,x0,x1);
	}
}
